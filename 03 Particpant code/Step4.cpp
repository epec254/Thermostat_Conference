...
void loop()
{
    ...
    sprintf(logResult, "{\"id\":%d,\"team\":\"%s\",\"c_tmp\":%d,\"d_tmp\":%d,\"heat\":\"%s\",\"cool\":\"%s\",\"status\":\"%s\",\"contest_status\":\"%s\"}", core_id, teamName, currentTemperature, desiredTemperature, isHeatOn ? "true" : "false", isCoolOn ? "true" : "false", thermostatStatus ? "on" : "off", contestStatus);
